/*
 [ SELECT ] 조건에 부합하는 중고거래 댓글 조회하기 (Lv1)
 ...
 2022년 10월에 작성된 게시글 제목, 게시글 ID, 댓글 ID, 댓글 작성자 ID, 댓글 내용, 댓글 작성일을 조회하는 SQL 문을 작성해주세요.
 결과는 댓글 작성일을 기준으로 오름차순 정렬해주시고, 댓글 작성일이 같다면 게시글 제목을 기준으로 오름차순 정렬해주세요.
 */

-- 조회  ) 게시글 제목, 게시글ID, 댓글ID, 댓글 작성자 ID, 댓글 내용, 댓글 작성일
SELECT b.TITLE,
       b.BOARD_ID,
       r.REPLY_ID,
       r.WRITER_ID,
...
-- 조건1) 2022년 10월에 작성된 게시글
WHERE b.CREATED_DATE LIKE '2022-10%'
-- 정렬1) 댓글 작성일 기준으로 오름차순
ORDER BY r.CREATED_DATE,
-- 정렬2) 게시글 제목 기준으로 오름차순
         b.TITLE;
